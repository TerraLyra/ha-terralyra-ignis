"""Research lifecycle with an injected HA-shaped asynchronous store interface."""
import asyncio
...
class AsyncStoredResearchCoordinator:
    ...
    async def setup(self):
        async with self._lock:
            ...
            try:
                ...
                raise
            self._inner = ResearchCoordinator(state=state, clock=self._clock, **self._kwargs)
