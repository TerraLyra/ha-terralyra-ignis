"""Opt-in research coordinator; no scheduler, disk writes or HA integration."""
...
from nifc_refresh import RefreshState, SourceHTTPError, due, failed, retry_after_seconds, succeeded, _clock
